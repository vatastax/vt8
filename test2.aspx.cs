...
public partial class test2 : System.Web.UI.Page
{
    ...
    static int cnt = 0;
    static DataSet ds;
    public enum Days { Sun = 1, Mon = 2, Tue = 3, Wed = 4, Thurs = 5, Fri = 6, Sat = 7 };

    protected void Page_Load(object sender, EventArgs e)
    {
        //System.Drawing.Pen pp = new System.Drawing.Pen();
        string sss = "abc:adad:asdasd:32323";
        string[] arrSSS = System.Text.RegularExpressions.Regex.Split(sss, ":");
        string vv = "123";
        int ii = System.Text.RegularExpressions.Regex.Matches(vv, @"[0-9]").Count;
        Response.Write("Counter: " + ii.ToString());
        string saa = "Ankush1To9";
        Response.Write("Ankush Counter:");
        Response.Write((System.Text.RegularExpressions.Regex.Matches(saa, "[0-9]").Count.ToString()));
        string ddt = "14/04/2016";
        Response.Write(string.Format("mm/dd/yyyy", "14/04/2016"));
        Response.Write(string.Format("{0:f2}", Convert.ToInt32(15000)));
        Response.Write("Date Today : " + DateTime.Now.ToShortDateString());
        Response.Write(((int)Days.Fri).ToString());
        Days dd = (Days)03;
        Response.Write("dd Value is: " + dd.ToString());
        Response.Write(((Days)2));
        Days ss = new Days();
        Response.Write("ss : " + ss.ToString());
        Response.Write("<br><br>");
        string strToRev = "Ankush";

        char[] ch = strToRev.ToCharArray();
        Array.Reverse(ch);
        Array.Sort(ch);
        string str2 = new string(ch);
        Response.Write("Reverse of String: " + str2);
    ...
    {
        Server.Transfer("testService.aspx", false);
    }
    ...
    public void addData()
    {
        ...
        //if (i <= 0)
        //{
        //    objbllStoreTrans.InsertDataMainGrid(objdenStoreTrans2);
        //}       
        //else
        //{
    ...
    //public object Base64_HMACSHA256(int iteration, string sTextToHash, string sSharedSecretKey)
    //    {     
    //        object functionReturnValue = null;
    //        object asc = null;
    //        object enc = null;
    //        byte[] TextToHash = null;
    //        byte[] SharedSecretKey = null;
        
    //        asc = Interaction.CreateObject("System.Text.UTF8Encoding");
    //        enc = Interaction.CreateObject("System.Security.Cryptography.HMACSHA256");
    ...
    //        }
    //        functionReturnValue = EncodeBase64(bytes);
    //        asc = null;
    //        enc = null;
