...
public partial class VwITRVforITR12014_15 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
           // filePath = Server.MapPath("~/xml/DFGPR1234R_ITR-1_2014_N_1234.xml"); //Server.MapPath(Request.QueryString["nid"].ToString() + ".xml");
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ITRVforITR12014-2015.rdlc");
