...
public partial class VwITRVforITR12015_16 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
           ...
           // filePath = @"C:\Users\harnek\Downloads\WSDPO3040T_ITR-1_2015_N_3040.xml";
            filePath = Server.MapPath(Request.QueryString["nid"].ToString() + ".xml");
            filepathdemo = Server.MapPath("~/DemoXMLs/itr1_distinct_rec.xml");
            ds.ReadXml(filePath);
           
            dsdemo.ReadXml(filepathdemo);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("ITRVforITR12015-2016.rdlc");
