...
public partial class VwITRVforITR4S2016_2017 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
           // filePath = Server.MapPath("~/ASDPO1234T_ITR-1_2016_N_1234 (1).xml");
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ITRVforITR4S2016-2017.rdlc");
            ...
            {
                datasourceITR1_TaxComputation = new ReportDataSource("TaxComputation", dsdemo.Tables["ITR4_TaxComputation"]);
            }
            ...
            {
                datasourceITR1 = new ReportDataSource("ITR1", ds.Tables["ITR4S"]);
            }
            else
            {
                datasourceITR1 = new ReportDataSource("ITR1", dsdemo.Tables["ITR4S"]);
            }
            ...
            if (ds.Tables.Contains("Form_ITR4S"))
            {
                datasourceForm_ITR1 = new ReportDataSource("Form_ITR1", ds.Tables["Form_ITR4S"]);
            }
            else
            {
                datasourceForm_ITR1 = new ReportDataSource("Form_ITR1", dsdemo.Tables["Form_ITR4S"]);
            }
