...
public partial class VwITRVforITR4S2014_2015 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            //filePath = Server.MapPath("~/xml/DFGPR1234R_ITR-1_2014_N_1234.xml");
            filePath = Server.MapPath(Request.QueryString["nid"].ToString() + ".xml");
            filepathdemo = Server.MapPath("~/DemoXMLs/ITR4S_14-15.xml");
            ds.ReadXml(filePath);

            dsdemo.ReadXml(filepathdemo);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("ITRVforITR4S2014-2015.rdlc");
