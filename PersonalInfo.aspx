<%@ Page Title="" Language="C#"  AutoEventWireup="true"
    CodeFile="PersonalInfo.aspx.cs" Inherits="Presentation_PersonalInfo" %>
...
//            alert('url=' + url);
//            if (url == 'http://localhost:2375/ITRProjectTFS/PersonalInfo.aspx?page=1') {
//                $('#step-1').css("display", "none");
//               
//                $('.buttonPrevious').css("display", "none");
//                $('#1').css("display", "none");
//                $('.a').css("display", "none");
//                $('.buttonDisabled').css("display", "none");
//            }
//            else {
//            }
...
<body>
    ...
    <div class="large-3 columns show-for-small-only ">
     ...
     <div class="row" style="margin-top: -20px;">
         <div class="large-3 columns hide-for-small hide-for-medium" > <!--Resolution Problem Solved - Jaipal -->
            <a href="Default.aspx"><img src="images/logo2.PNG" alt="logo" style="width:240px; height:auto" /></a>
     </div>
        <div class="large-9 columns hide-for-small hide-for-medium "> <!--Resolution Problem Solved - Jaipal -->
            ...
            <div id="wizard1" class="swMain">
             ...
             <%--       <li id="1"><a href="#step-1">
                    ...
                    <li><a href="#step-4">
                        ...
                        <span class="stepDesc">Assigned Expert Details<br />
                            <%--     <small>Step 4 description</small>--%>
                        </span></a></li>
                </ul>
 <%--               <div id="step-1" class="a">
                    <h2 class="StepTitle">
