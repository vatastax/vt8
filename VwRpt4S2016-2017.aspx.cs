...
public partial class VwRpt4S2016_2017 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            filepathdemo = Server.MapPath("~/DemoXMLs/itr4s16-17.xml");
            ds.ReadXml(filePath);
            dsdemo.ReadXml(filepathdemo);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rpt4Sfor2016-2017.rdlc");
            ...
            if (columns.Contains("AadhaarCardFlg"))
    {
        ...
        else if (ds.Tables["PersonalInfo"].Rows[0]["AadhaarCardFlg"].ToString() == "Y")
        {
            ...
            //TradeName
            ReportDataSource datasourceNatureOfBusiness;
            if (ds.Tables.Contains("NatureOfBusiness"))
            {
                datasourceNatureOfBusiness = new ReportDataSource("NatureOfBusiness", ds.Tables["NatureOfBusiness"]);
            }
            else
            {
                datasourceNatureOfBusiness = new ReportDataSource("NatureOfBusiness", dsdemo.Tables["NatureOfBusiness"]);
            }
            //ScheduleBPForITR4S
            // ReportDataSource datasourceScheduleBPForITR4S;
            if (ds.Tables.Contains("ScheduleBPForITR4S"))
            ...
            //NoBookksOfAccBS
           // ReportDataSource datasourceNoBooksOfAccBS;
            if (ds.Tables.Contains("NoBookksOfAccBS"))
            {
                datasourceNoBooksOfAccBS = new ReportDataSource("NoBooksOfAccBS", ds.Tables["NoBooksOfAccBS"]);
            }
            else
            ...
            {
                datasourceITR1 = new ReportDataSource("ITR4S", ds.Tables["ITR4S"]);
            }
            else
            {
                datasourceITR1 = new ReportDataSource("ITR4S", dsdemo.Tables["ITR4S"]);
            }
           ...
           // ReportViewer1.LocalReport.DataSources.Add(datasourceNoBooksOfAccBS);
            ...
            ReportViewer1.LocalReport.DataSources.Add(datasourceNatureOfBusiness);
