...
public partial class VwITR12014_2015 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            filepathdemo = Server.MapPath("~/DemoXMLs/itr1_2014-2015.xml");
            ds.ReadXml(filePath);
            dsdemo.ReadXml(filepathdemo);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Rpt1for2014-2015.rdlc");
            ...
            //EmployerorDeductor
            ReportDataSource datasourceEmployerorDeductor, datasourceEmployerorDeductorfortds2;
