...
public partial class View4SRpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            filepathdemo = Server.MapPath("~/DemoXMls/itr4s_15_16.xml");
            ds.ReadXml(filePath);
            dsdemo.ReadXml(filepathdemo);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Rpt4S.rdlc");
           ...
           // string DOB = arrDOB[2] + "-" + arrDOB[1] + "-" + arrDOB[0];
            ...
            if (ds.Tables.Contains("FilingStatus"))
            {
                ...
                {
                    datasourceDeductUndChapVIA = new ReportDataSource("DeductUndChapVIA", dsdemo.Tables["DeductUndChapVIA"]);
                }
                ...
                //{
                //    datasourceTCS = new ReportDataSource("NoBooksOfAccBS", ds.Tables["NoBooksOfAccBS"]);
                //}
                //else
                //{
                //    datasourceTCS = new ReportDataSource("NoBooksOfAccBS", dsdemo.Tables["NoBooksOfAccBS"]);
                //}
                ...
                ReportViewer1.LocalReport.DataSources.Add(datasourceEmployerorDeductorfortds1);
                ReportViewer1.LocalReport.DataSources.Add(datasourceEmployerorDeductorfortds2);
