...
public partial class Presentation_student_mainid : System.Web.UI.Page
{
    ...
    void VGrid1_VGrid_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        objbllSalary.FetchTransData("15104", Session["NameID"].ToString(), Session["ay"].ToString(), Convert.ToInt32(VGrid1.SelectedDataKey));
        Session["IncomeTax_VType"] = "15104";
        Response.Redirect("IncomeTax");
    }
