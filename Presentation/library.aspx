<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPage3.master" AutoEventWireup="true" CodeFile="library.aspx.cs" Inherits="Presentation_library" %>
...
<div class="row">
    <div class="large-12 columns hide-for-small-only">
        <DB:DynamicButtons_Service ID="dny_BOBtn" runat="server" Control_ID="ankushpanel"
            Page_ID="library" Page_ModuleID="100" />
    </div>
</div>
</asp:Content>