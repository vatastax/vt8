<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadForm16.aspx.cs" Inherits="Presentation_UploadForm16" %>
...
<link href="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.9/themes/start/jquery-ui.css" type="text/css" />
   <link href="../style_folder/StaticStyleSheet.css" rel="stylesheet" type="text/css" />
     ...
     <%--  <script src="../js/MasterJScript.js" type="text/javascript"></script>--%>
      <script type="text/javascript">
                  ...
                  $("#dialog").dialog({
                      ...
                      buttons: {
                          Close: function () {
                           ...
                           OK: function () {
                             window.location="UploadForm16B.aspx"
          ...
          function ShowPopupAssessee(message) {
              $(function () {
                  $("#dialog").html(message);
                  $("#dialog").dialog({
                      title: "Query Support",
                      buttons: {
                          ...
                          OK: function () {
                              window.location = "AssesseeSelect.aspx"
...
<body>
   ...
   <%-- <div class="row ">
    ...
    <br />
    <%--<div style="border: 1px solid gray; padding: 30px; box-shadow: 10px 10px 5px #888888;"
        class="row">--%>
        <div class="row">
        <div class="login-wrap" style="height: 140px;background-color: White;width: auto;max-width: 500px;" >
