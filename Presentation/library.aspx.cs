...
public partial class Presentation_library : System.Web.UI.Page
{
    ...
    void VGrid1_VGrid_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        objbllSalary.FetchTransData("15102", Session["NameID"].ToString(), Session["ay"].ToString(), Convert.ToInt32(VGrid1.SelectedDataKey));
        Session["IncomeTax_VType"] = "15102";
        Response.Redirect("IncomeTax");
    }
