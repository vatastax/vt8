<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteReturn.aspx.cs" Inherits="Presentation_DeleteReturn" %>
<%@ Register Src="~/UserControls/TDS_Delete.ascx" TagName="Delete" TagPrefix="del" %>
    ...
    function Comfirm2() {
        try {
            ...
            if (confirm("Do You Want To Delete The Data?")) {
                confirm_value = 'Yes';
                var check = '<%=Session["Mudit"] ="Yes" %>';
                window.location = "DeleteReturn.aspx";
            } else {
                confirm_value = "No";
                window.location = "Salary.aspx?VType=3001";
            }
        }
        catch (e) { alert(e); }
    }
...
<body onload="Confirm1();">
  ...
  <div class="row hide-for-small-only">
    ...
    <del:Delete ID="del" runat="server" />
    </div>
    </div>
   </ContentTemplate>
    </asp:UpdatePanel>
