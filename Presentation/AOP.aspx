<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AOP.aspx.cs" Inherits="Presentation_AOP" %>
...
<br />
 <div class="row ">
    ...
    <%----------------change location of breadcrumps to right 11/4/2015-------------------------------------------------------------------------------%>
     <div class="row">
     <br />
...
<br />
   ...
   <div id="hide" class="button">Check Assessess Details</div>
     </div>
     </div>
...
<asp:TextBox ID="txtNameAOP" runat="server" ></asp:TextBox>
...
<div class="large-8 columns">
 <asp:TextBox ID="txtDateAOP" runat="server"  type="date" Width="171px"></asp:TextBox>
 ...
 <div class="large-3 columns">
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtFlat"
 ...
 <div class="large-3 columns">
  <asp:DropDownList ID="ddlState" runat="server" DataSourceID="ObjectDataSource1" DataTextField="StateName" DataValueField="StateCode" Width="171px" >
                                                            </asp:DropDownList>
 </div>
 </div>
...
<div class="large-8 columns">
<asp:TextBox ID="txtTANAOP" runat="server" ></asp:TextBox>
</div>
</div>
<br />
<div class="row">
...
<div class="large-8 columns">
<asp:TextBox ID="txtWardAOP" runat="server" ></asp:TextBox>
</div>
</div>
<br />
<div class="row">
...
<div class="row">
<div class="large-4 columns"> <asp:RadioButton ID="rdoRepresentative" runat="server" AutoPostBack="True" GroupName="grpSignatory"
                                OnCheckedChanged="rdoRepresentative_CheckedChanged" Text="Representative" /></div>
<div class="large-8 columns"><asp:RadioButton
                                ID="rdoSelf" runat="server" AutoPostBack="True" GroupName="grpSignatory" OnCheckedChanged="rdoSelf_CheckedChanged"
                                Text="Self/Director/Partner" /></div>
</div>
  <div class="row">
  <div class="large-12 columns">
    ...
    <div class="large-8 columns">
      <asp:TextBox ID="txtPANRep" runat="server" style="text-transform:uppercase" ></asp:TextBox>
    </div>
    </div>
    <br />
     <div class="row">
