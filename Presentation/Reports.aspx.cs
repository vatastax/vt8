...
public partial class Presentation_Reports : System.Web.UI.Page
{
                ...
                if (s.Length > 0)
                {
                    ...
                    else if (Session["ITR"].ToString() == "1")
                    {
                        if (Session["AY"].ToString() == "2014-2015")
                            Response.Redirect("../VwITR12014-2015.aspx?nid=~/GetXMLs/" + Session["NameID"].ToString() + "_" + Session["AY"].ToString());
                        else if (Session["AY"].ToString() == "2015-2016")
                            Response.Redirect("../ViewReport.aspx?nid=~/GetXMLs/" + Session["NameID"].ToString() + "_" + Session["AY"].ToString());
                        else if (Session["AY"].ToString() == "2016-2017")
                            Response.Redirect("../VwRpt1for2016-2017.aspx?nid=~/GetXMLs/" + Session["NameID"].ToString() + "_" + Session["AY"].ToString());

                    }
                    else if (Session["ITR"].ToString() == "8")
                    {
                        if (Session["AY"].ToString() == "2014-2015")
                            Response.Redirect("../VwRpt4s2014-15.aspx?nid=~/GetXMLs/" + Session["NameID"].ToString() + "_" + Session["AY"].ToString());
                        else if (Session["AY"].ToString() == "2015-2016")
                            Response.Redirect("../View4SRpt.aspx?nid=~/GetXMLs/" + Session["NameID"].ToString() + "_" + Session["AY"].ToString());
                        else if (Session["AY"].ToString() == "2016-2017")
                            Response.Redirect("../VwRpt4S2016-2017.aspx?nid=~/GetXMLs/" + Session["NameID"].ToString() + "_" + Session["AY"].ToString());
