...
public partial class Presentation_Employee_Salary : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        VGrid1.CustomConnection = "Data Source=Dev1;Initial Catalog=ControlGrid;User Id=sa; Password=sql,.12345";
        VGrid1.GridName = "grdEmployer3";
		//#Paramters/
        VGrid1.Parameters = Session["NameID"].ToString() + "," + Session["NameID"].ToString() + "," + Session["NameID"].ToString() + "," + Session["NameID"].ToString() + "," + Session["NameID"].ToString() + "," + Session["NameID"].ToString();
        VGrid1.DataBind();
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (dny_BOBtn.Client_NoAction == "N")
            Response.Redirect("manageLinking.aspx?vtype=13011");
	...
	void dny_BOBtn_btn_buttonClick(object sender, EventArgs e)
    {
        ...
        string MainID = objbllStoreTrans.getMainID(Session["NameId"].ToString(), "13011");
