<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPage3.master" AutoEventWireup="true" CodeFile="stnew2.aspx.cs" Inherits="Presentation_stnew2" %>
...
<div class="row">
    <div class="large-12 columns hide-for-small-only">
        <DB:DynamicButtons_Service ID="dny_BOBtn" runat="server" Control_ID="Pnl_Btn1"
            Page_ID="stnew2" Page_ModuleID="100" />
    </div>
</div>
</asp:Content>