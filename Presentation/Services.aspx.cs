...
public partial class Presentation_Service : System.Web.UI.Page
{
    int i;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Request.UserAgent.Contains("MSIE 9.0") || Request.UserAgent.Contains("MSIE 10.0") || Request.UserAgent.Contains("rv:11.0"))
            {
                iemsg.Visible = true;
            }
            else
    ...
    protected void lbtnITR_Click(object sender, System.EventArgs e)
    {
        Session["Project"] = "vt";
        Response.Redirect("Main.aspx");
    }

    protected void lbtnTDS_Click(object sender, System.EventArgs e)
    {
        Session["Project"] = "tds";
