<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPage3.master" AutoEventWireup="true" CodeFile="DDOListing.aspx.cs" Inherits="Presentation_DDOListing" %>
...
<div class="row">
    <div class="large-12 columns hide-for-small-only">
        <DB:DynamicButtons_Service ID="dny_BOBtn" runat="server" Control_ID="Pnl_Btn1"
            Page_ID="DDOListing" Page_ModuleID="100" />
    </div>
</div>
</asp:Content>