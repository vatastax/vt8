<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndividualUser.aspx.cs" Inherits="Presentation_IndividualUser" %>
...
<head id="Head1" runat="server">
    ...
    <%-------------------------------java script code fro validate form -------------------------------------------------------------%>
     <script type="text/javascript">
         ...
         function setBankVal(val) {
             try {
                 if (document.getElementById('txtAccountNumber').value != '' && document.getElementById('txtMICR').value != '' && document.getElementById('txtBankName').value != ''&& (document.getElementById('txtMICR').value).length<12) {
    ...
    <script type="text/javascript">
        ...
        function validate() {
            //ShowPopup('msg');
            //if ($('hdnIsBank').val() != undefined) {
            if(document.getElementById('hdnIsBank').value!='none'){
                var regexp1 = new RegExp("\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*");
                var regexp2 = new RegExp("[a-zA-Z0-9]([/-]?(((\d*[1-9]\d*)*[a-zA-Z])|(\d*[1-9]\d*[a-zA-Z]*))+)*[0-9]*")
                ...
                if ((document.getElementById('txtPIN').value).length < 6)
                    varMsg += '<tr><td>Invalid PIN.!</td></tr>';
                if (document.getElementById('txtAadhar').value != '') {
                    if ((document.getElementById('txtAadhar').value).length < 12)
                        varMsg += '<tr><td>Invalid Aadhar.!</td></tr>';
                }
                if (document.getElementById('txtMICR').value != '') {
                    if ((document.getElementById('txtMICR').value).length < 11)
                        varMsg += '<tr><td>Invalid IFSC Code.!</td></tr>';
                }
                if (document.getElementById('txtSTD').value != '') {
                    if (document.getElementById('txtPhone').value == '') {
                        varMsg += '<tr><td>If you enter std code then please enter phone No.</td></tr>';
                    }
                }
                else {
                    ...
                    if (/\d{12}/i.test(document.getElementById("txtAadhar").value) == false && document.getElementById("txtAadhar").value != '') {
                        ...
                        if ((document.getElementById('txtAadhar').value).length < 12)
                            varMsg += '<tr><td>Invalid Aadhar.!</td></tr>';
                        if ((document.getElementById('txtMICR').value).length < 12)
                            varMsg += '<tr><td>Invalid IFSC Code.!</td></tr>';
                    }
                ...
                ShowPopup('Please Enter Bank Details2');
                return false;
            }
        }
    </script>
    ...
    <script type="text/javascript">
        ...
        function nextTab(id, IsVal) {
            ...
            if (IsVal == '1') {                
                if (id == 'a_Addr') {
                    if (document.getElementById('txtLastName').value == '')
                        IsValidated = 'Enter Last Name</br>';
                    if (document.getElementById('txtFatherName').value == '')
                        IsValidated += 'Enter Father Name</br>';
                    if (document.getElementById('txtDOB').value == '')
                        IsValidated += 'Enter Date of Birth</br>';
                    if (document.getElementById('txtAadhar').value != "") {
                        if ((document.getElementById('txtAadhar').value).length < 12)
                            IsValidated += 'Incorrect Aadhar No</br>';
                    }
                    if (IsValidated != '') {
                    ...
                    if ((document.getElementById('txtMobile1').value).length < 10 || (document.getElementById('txtMobile1').value.substring(0,1)=='0'))
                        IsValidated += 'Incorrect Mobile No.</br>';
                    if (document.getElementById('txtMobile2').value != '') {
                        if ((document.getElementById('txtMobile2').value).length < 10)
                            IsValidated += 'Incorrect Mobile No2.</br>';
                    }
                    if (/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i.test(document.getElementById("txtEmail").value) == false)
                        IsValidated += '<br> Invalid Email ID';

                    if (document.getElementById('txtSTD').value != '') {
                        if (document.getElementById('txtPhone').value == '') {
                            IsValidated += '<br> If you enter std code then please enter phone No.';
                        }
                    }
...
<body onload="P7_ExpMenu()" class="no-js">
    ...
    <div class="row show-for-small-only ">
        ...
        <div class="large-6 columns text-right ">
            Welcome <span style="font-weight: bold;color:#008CBA;">
    ...
    <div class="container-fluid">
        ...
        <p class="bg-primary"><asp:Label ID="lblHeading" runat="server" 
                ...
                <p style="text-align:right;">
                        ...
                        <a href="Main.aspx"><input type="button" value="Back to Main" class="newbtn" /></a>
                        </p>
                <div class="container-fluid">
                ...
                <div class="tab-content">
                    <div id="SectionA" class="tab-pane fade in active">
                        <div class="row">
                            ...
                            <div class="large-3 columns">
                                <asp:DropDownList ID="ddlSalute" runat="server" Height="34px">
                            ...
                            <div class="large-3 columns">
                              ...
                              MaxLength="25" onchange="setNaming(this);setUpper(this)"></asp:TextBox></div>
                        </div>
                   <%--     <br />--%>
                        ...
                        <div class="row" >
                            ...
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtMiddleName" runat="server" onchange="setUpper(this)"
                                    class="form-control" placeholder="Middle Name" MaxLength="25"></asp:TextBox>
                            </div>
                            <div class="large-3 columns">
                                <asp:Label ID="Label5" runat="server" Text="Last Name"></asp:Label><span style="color: Red">*</span>
                            </div>
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtLastName" runat="server" onchange="setUpper(this)" required
                                    class="form-control" placeholder="Last Name"  MaxLength="75"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtFatherName" runat="server" required
                                    class="form-control" placeholder="Father's Name" MaxLength="125" onchange="setNaming(this);setUpper(this);"></asp:TextBox>
                            ...
                            <div class="large-3 columns">
                                <asp:Label ID="Label9" runat="server" Text="Date of Birth"></asp:Label><span style="color: red">*</span>
                            </div>
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtDOB" runat="server" Width="230px" Height="34px" onfocus="enableDOB();" required
                                    MaxLength="12" placeholder="DD/MM/YYYY" onchange="javascript:validateAY_DOB(this, true);" onkeydown="javascript:if(event.keyCode==8||event.keyCode==46){this.value='dd/MM/yyyy';}"
onblur="javascript:if(this.value=='dd/MM/yyyy'){this.value='';}"
></asp:TextBox>
                               ...
                               <%-- <asp:MaskedEditExtender ID="txtdob_MaskedEditExtender" runat="server" Century="2000"
                                ...
                                <asp:textboxwatermarkextender id="WatermarkExtender1" runat="server"
targetcontrolid="txtDOB" watermarktext="DD/MM/YYYY">
</asp:textboxwatermarkextender>
<asp:calendarextender id="trnCal" runat="server" format="dd/MM/yyyy"
targetcontrolid="txtDOB">
...
masktype="Date" ClearTextOnInvalid="false" messagevalidatortip="true" targetcontrolid="txtDOB">
</asp:maskededitextender>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            ...
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtWard" runat="server" class="form-control" MaxLength="75" Height="34px"
                                    placeholder="AO Code/Area Code"></asp:TextBox></div>
                        </div>
                        <div class="row">
                            <div class="large-3 columns">
                            ...
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtAadhar" runat="server" Width="230px" placeholder="Aadhar No."
                                    MaxLength="12" onchange="javascript:validateAadharNo(this)"></asp:TextBox>
                                     <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" FilterMode="ValidChars" FilterType="Numbers" TargetControlID="txtAadhar"></asp:FilteredTextBoxExtender>
                                    <div id="DivAadhar" style="color: Red"></div>
                                    <%-- <asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server"  Mask="999999999999" MaskType="Number"
                                    TargetControlID="txtAadhar">
                                </asp:MaskedEditExtender>--%>
                        ...
                        <p style="text-align:right;">
                        <input type="button" value="Next" style="font-weight:bold" class="radius button" onclick="nextTab('a_Addr','1');" />
                        </p>
                    </div>
                    <div id="sectionB" class="tab-pane fade">
                        ...
                        <div class="row">
                            ...
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtPIN" runat="server" class="form-control" placeholder="Pin Code"
                                    ...
                                    <asp:FilteredTextBoxExtender ID="FTM1" runat="server" FilterMode="ValidChars" FilterType="Numbers" TargetControlID="txtPIN"></asp:FilteredTextBoxExtender>
                                     <%-- <asp:MaskedEditExtender ID="MaskedEditExtender2" runat="server"  Mask="999999" MaskType="Number"
                                    TargetControlID="txtPIN">
                                </asp:MaskedEditExtender>--%>
                          <%--      <asp:MaskedEditValidator ID="MV1" runat="server" ControlToValidate="txtPIN" ControlExtender="MaskedEditExtender2" ErrorMessage="Entered PIN is not correct"></asp:MaskedEditValidator>--%>
                        ...
                        <div class="row">
                            ...
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtSTD" runat="server" class="form-control" placeholder="STD Code" onchange="removeZeroes(this);setPhoneLength(this);"
                            ...
                            <div class="large-3 columns">
                                <asp:TextBox ID="txtMobile1" runat="server" class="form-control" placeholder="Mobile Number1"
                                    MaxLength="10" onchange="javacsript:ValidMobileNo(this)"></asp:TextBox>
                                     ...
                                     <%--<asp:MaskedEditExtender ID="MaskedEditExtender4" runat="server"  Mask="9999999999" MaskType="Number"
                                    TargetControlID="txtMobile1"></asp:MaskedEditExtender>--%>
                    ...
                    <div id="sectionc" class="tab-pane fade">
                                ...
                                <div class="row">
                                    ...
                                    <div class="large-4 columns">
                                        <asp:TextBox ID="txtBankName" runat="server" class="form-control" placeholder="Name of Bank"
                                            MaxLength="125" onchange="setUpper(this)" required></asp:TextBox></div>
                                    <div class="large-4 columns">
                                    </div>
                                </div>
                                <br />
                                ...
                                <div class="row">
                                    ...
                                    <div class="large-4 columns">
                                        <asp:TextBox ID="txtAccountNumber" runat="server" class="form-control" placeholder="Account Number"
                                            MaxLength="20" ValidationGroup="gg" required></asp:TextBox>
                                ...
                                <div class="row">
                                    ...
                                    <div class="large-4 columns">
                                        <asp:TextBox ID="txtMICR" runat="server" class="form-control" Placeholder="IFSC Code"
                                            ...
                                            <%--<asp:MaskedEditExtender ID="MaskedEditExtender3" runat="server"  Mask="99999999999" MaskType="Number"
                                    TargetControlID="txtMICR">
                                </asp:MaskedEditExtender>--%>
                        ...
                        <p style="text-align:right"> <input type="button" value="Back" class="radius button" onclick="nextTab('a_Addr','0');" style="font-weight:bold;width:145px" />
                                <asp:Button ID="btnInsert" runat="server" Text="Save" OnClientClick="return validate();"
                                    OnClick="Button1_Click1" class="radius button" Font-Bold="true" formnovalidate  style="width:145px"/>
                          <asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClick="btnCancel_Click" class="radius button" style="font-weight:bold;width:145px" formnovalidate  /></p>
