<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPage3.master" AutoEventWireup="true" CodeFile="student_mainid.aspx.cs" Inherits="Presentation_student_mainid" %>
...
<div class="row">
    <div class="large-12 columns hide-for-small-only">
        <DB:DynamicButtons_Service ID="dny_BOBtn" runat="server" Control_ID="pnl_View"
            Page_ID="student_mainid" Page_ModuleID="100" />
    </div>
</div>
</asp:Content>