<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPage3.master" AutoEventWireup="true" CodeFile="lstStudents.aspx.cs" Inherits="Presentation_lstStudents" %>
...
<div class="row">
    <div class="large-12 columns hide-for-small-only">
        <DB:DynamicButtons_Service ID="dny_BOBtn" runat="server" Control_ID="pnl_View"
            Page_ID="lstStudents" Page_ModuleID="100" />
    </div>
</div>
</asp:Content>