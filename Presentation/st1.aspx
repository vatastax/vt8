<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPage3.master" AutoEventWireup="true" CodeFile="st1.aspx.cs" Inherits="Presentation_st1" %>
...
<div class="row">
    <div class="large-12 columns hide-for-small-only">
        <DB:DynamicButtons_Service ID="dny_BOBtn" runat="server" Control_ID="abc"
            Page_ID="st1" Page_ModuleID="100" />
    </div>
</div>
</asp:Content>