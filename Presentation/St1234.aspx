<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPage3.master" AutoEventWireup="true" CodeFile="St1234.aspx.cs" Inherits="Presentation_St1234" %>
...
<div class="row">
    <div class="large-12 columns hide-for-small-only">
        <DB:DynamicButtons_Service ID="dny_BOBtn" runat="server" Control_ID="Pnl_Btn1"
            Page_ID="St1234" Page_ModuleID="100" />
    </div>
</div>
</asp:Content>