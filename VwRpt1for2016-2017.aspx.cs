...
public partial class VwRpt1for2016_2017 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Rpt1for2016-2017.rdlc");
                ...
                if (ds.Tables.Contains("FilingStatus"))
                {
                    ...
                    else if (ds.Tables["FilingStatus"].Rows[0]["ResidentialStatuse"].ToString() == "NOR")
                    {
                ...
                //}
                //Code to Generate PDF directly without opening up the Report
            ...
            catch (Exception ex)
            {
                ...
                //ClientScript.RegisterClientScriptBlock(GetType(), "asd", "<script type='text/javascript'>alert('" + ex.Message + "');</script>");
            }
